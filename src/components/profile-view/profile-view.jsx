...
updateUserDetails(e) {
    ...
    if (form.checkValidity() === false) {
        ...
        axios.put(`https://haksuly1movieapp.herokuapp.com/users/${user}`, {
...
deleteUserDetails() {
    let token = localStorage.getItem("token");
    let user = localStorage.getItem("user");
    axios.delete(`https://haksuly1movieapp.herokuapp.com/users/${user}`, {
        headers: { Authorization: `Bearer ${token}`}
    }).then(response => {
        const data = response.data;
    ...
    return (
        <div className="profile_view">
            ...
            <Modal show={this.state.modalState} onHide={this.closeModal}>
                ...
                <Modal.Body>Confirm deletion. Note: There is nno nway to restore a deleted profile</Modal.Body>
                <Modal.Footer>
            ...
            <Card bg="secondary" text="light" border="light">
                <Card.Body>
                    ...
                    <Form noValidate validated={this.state.validated}>
                        ...
                        <Button variant="light" style={{ color: "blue" }} type="submit" onClick={this.updateUserDetails}>
                            Update Details
                        </Button>
                        ...
                        <Button className="float-right" variant="light" style={{ color: "blue" }} onClick={this.showModal}>
                            Delete User Profile
                        </Button>
                    </Form>
                </Card.Body>
            ...
            <Card bg="secondary" text="light" border="light" align="center" style={{ color: "blue" }}>
